...
# define MV_UP_MASK 1
# define MV_DOWN_MASK 2
# define MV_RIGHT_MASK 4
# define MV_LEFT_MASK 8
# define LK_RIGHT_MASK 16
# define LK_LEFT_MASK 32
# define ESC_MASK 64
...
# define LEFT XK_A
# define RIGHT XK_D
# define LLEFT XK_LEFT
# define LRIGHT XK_RIGHT
